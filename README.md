[![Compliance with Ledger guidelines](https://github.com/TheBunkerCoin/ledger-bunkercoin/actions/workflows/guidelines_enforcer.yml/badge.svg?branch=main)](https://github.com/TheBunkerCoin/ledger-bunkercoin/actions/workflows/guidelines_enforcer.yml)

[![Build and functional tests](https://github.com/TheBunkerCoin/ledger-bunkercoin/actions/workflows/build_and_functional_tests.yml/badge.svg?branch=main)](https://github.com/TheBunkerCoin/ledger-bunkercoin/actions/workflows/build_and_functional_tests.yml)

# BunkerCoin Ledger App

App for Ledger, enabling users to store BunkerCoin on Ledger devices.
...
* [Go on Ledger's Dev Discord](https://developers.ledger.com/discord-pro/) to chat with developer support and the developer community.
